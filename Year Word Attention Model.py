...
container_directory = "/scratchd/home/swayambhu/Time_Stamping/Dumped_files/year_word_apw/List_of_Documents/"
test_directory = "/scratchd/home/swayambhu/Time_Stamping/Dumped_files/year_word_apw/"
        ...
        for i in range(num_of_container):
            ...
            for batches in containBatch:
                ...
                for elems in doc_in_batch:
                    ...
                    doc_end = keep_doc.document_length + doc_start
